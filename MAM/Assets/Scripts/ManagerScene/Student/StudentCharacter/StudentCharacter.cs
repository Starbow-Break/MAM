...
public class StudentCharacter : MonoBehaviour
{
    ...
    [SerializeField] private CharacterClickDetecter _detecter = null;
    ...
    public void InitializeClickDetecter()
    {
        _detecter.gameObject.SetActive(true);
        _detecter.OnCharacterClick += () => { SelfStudySceneManager.StudentClickPopupSetter.OpenPopup(ID); };
    }
}
